...
public class PlayerContext {
     ...
     */
    private final Map<GameObjectType, Integer> countByObjectTypes = new HashMap<>();
     ...
     */
    private final Map<GameObjectType, Integer> objectLimitMap = new HashMap<>();
     ...
     */
    private final Map<GameObjectType, Map<ResourceType, Integer>> gameObjectCosts = new HashMap<>();
